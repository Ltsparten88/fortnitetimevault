...
module.exports = (app) => {
    ...
    if (command == "MarkNewQuestNotificationSent")
    {
      res.status(500).json({
                "errorCode": "",
                "errorMessage": "Sorry. But you got reset because you selected a gamemode. We are currently working on this.\nTo get back your cosmetic, Just go back to select gamemode menu and your cosmetics should be back.",
                "messageVars": [],
    ...
    //Beat YT : Im not familiar whit Neonite MCP, Its way to("o automatized
