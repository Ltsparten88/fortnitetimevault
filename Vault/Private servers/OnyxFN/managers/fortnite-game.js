module.exports = (app) => {
  app.get("/content/api/pages/fortnite-game", (req, res) => {
    if (req.headers["user-agent"]) {
      try {
        season = "season" + req.headers["user-agent"].split("-")[1].split(".")[0]
        if (season == "season10") season = "seasonx"
      } catch {
        season = "worldcup"
      }
    } else season = "worldcup"
    ...
    res.json({
      ...
      "playlistinformation": {
        ...
        "playlist_info": {
          ...
          "playlists": [{
            "image": "https://cdn.discordapp.com/attachments/707678703467102228/780965122940076053/MyMOD_trashy_pic.png",
            ...
            "display_subname": ""
                ...
                "image": "https://cdn.discordapp.com/attachments/765757033768288266/784896942873772062/Party_GIrl_playlist.png",
                "playlist_name": "Playlist_Intro_Apollo_NewPlayer",
                "hidden": false,
                "_type": "FortPlaylistInfo",
                "display_subname": "New world (new player)"
            },{
                "image": "https://cdn.discordapp.com/attachments/765757033768288266/784896984522686484/New_World_battle_buss.png",
                "playlist_name": "Playlist_Intro_Apollo_CurrentPlayer",
                "hidden": false,
                "_type": "FortPlaylistInfo",
                "display_subname": "New world"
            }, {
            "image": "https://cdn.discordapp.com/attachments/707678703467102228/780965122940076053/MyMOD_trashy_pic.png",
      ...
      "dynamicbackgrounds": {
        ...
        "backgrounds": {
          "backgrounds": [{
            "backgroundimage": "https://cdn.discordapp.com/attachments/707678703467102228/780965122940076053/MyMOD_trashy_pic.png",
            "stage": season,
      ...
      "battleroyalenewsv2": {
        "news": {
          "motds": [{
            "entryType": "text",
            "image": "https://cdn.discordapp.com/attachments/707678703467102228/780965122940076053/MyMOD_trashy_pic.png",
            "tileImage": "https://cdn.discordapp.com/attachments/707678703467102228/780965122940076053/MyMOD_trashy_pic.png",
            "videoMute": false,
            "hidden": false,
            "tabTitleOverride": "MYMOD",
            "_type": "CommonUI Simple Message MOTD",
            "title": "MyMOD",
            "body": "Welcome to MyMod. Made By Beat YT\n Server made by Kemo.",
            "videoLoop": false,
      ...
      "Creativenewsv2": {
        "news": {
          "motds": [{
            ...
            "_type": "CommonUI Simple Message MOTD",
            "title": "MyMOD",
            "body": "Welcome to MyMod. Made By Beat YT, Jacobb626YT And Ender.",
            "videoLoop": false,
            "videoStreamingEnabled": false,
            "sortingPriority": 80,
            "id": "NeoniteNewsCreative",
            "videoAutoplay": false,
            "videoFullscreen": false,
            "spotlight": false
          }]
      ...
      "shopCarousel": {
        ...
        "itemsList": {
          ...
          "items": [{
            "tileImage": "https://cdn.discordapp.com/attachments/772946198033727498/784940226044231700/Untitled_1.png",
            "fullTitle": "MYMOD",
            "hidden": false,
